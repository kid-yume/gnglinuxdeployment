...
Gng Recommended Best Practice Guides Deployment
======
<!-- mdformat on -->
...
taken throughout the process handy for input during this process. 
...
### Next Steps
You are up and running! Now its just to add Chrome Devices to your platform! 
